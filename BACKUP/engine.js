const RenoEngine = {
    ...
    getCEMSize: function(totalKva) {
        ...
        else if (serviceBreaker.includes('3x50') || serviceBreaker.includes('3x60')) mainSwitch = '63A TP';
        else if (serviceBreaker.includes('3x80') || serviceBreaker.includes('3x100')) mainSwitch = '100A TP';
        else mainSwitch = '160A TP';
        
        return { meterKva, serviceBreaker, mainSwitch, meterDisplay: `3-Ph Meter (${meterKva} kVA)` };
    },
