const RenoEngine = {
    ...
    calculateCircuits: function(circuits) {
        ...
        circuits.forEach((circuit, idx) => {
            ...
            // [精準修改] 計算邏輯
            // 只有「非廚房」的「普通插座」才鎖定按 1000W 計算
            // 廚房插座將進入 else 區塊，正確執行：功率 x 數量
