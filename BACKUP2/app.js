const RenoApp = {
    ...
    unlockPremium: async function() {
        ...
        try {
            ...
            // Fixed Y-Position for Chart to avoid collision
            doc.addImage(chartImgData, 'PNG', 220, 165, 60, 45);
    ...
    generateReportImage: function(project, result, logoImg) {
        return new Promise((resolve) => {
            ...
            // ✅ WIDENED BOX & UPDATED LABELS
            const infoBoxWidth = 1400; // Increased width to fit long labels
            ...
            const valueX = infoBoxX + 900; // Moved values further right
            ...
            // Row 2
            ctx.font = 'bold 34px "Noto Sans TC", sans-serif';
            ctx.fillText('Contract Power-Palim.(電錶功率(kVA)):', labelX, infoBoxY + 140);
            ctx.font = '34px "Noto Sans TC", sans-serif';
        ...
        new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    legend: {
                        position: 'bottom',
                        labels: { font: { size: 100 }, padding: 20 }
                    },
                    title: {
                        display: true,
