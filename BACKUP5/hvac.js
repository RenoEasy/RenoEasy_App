...
const HVACModule = {
    ...
    renderTable: function() {
        ...
        this.items.forEach((item, index) => {
            html += `
            <div class="grid-row grid-cols-hvac">
                <div class="grid-cell">${index + 1}</div>
                <div class="grid-cell" style="justify-content:flex-start; font-weight:500;">${item.type}</div>
                <div class="grid-cell">${item.A}</div>
                <div class="grid-cell">${item.H}</div>
                <div class="grid-cell">${item.Ppl}</div>
                <div class="grid-cell">${item.Vol}</div>
                <div class="grid-cell">${item.ach}</div>
                <div class="grid-cell font-bold" style="color:var(--primary-color);">${item.reqEA_CMH}</div>
                <div class="grid-cell font-bold" style="color:var(--hvac-color);">${item.reqFA_LS}</div>
                <div class="grid-cell">${item.ESP}</div>
                <div class="grid-cell">
